 ...
 * The 9th SOFT entry `Subject preferred slot` is added in Phase 14 Task 5
 * (NEW Java constraint stream + new @ConstraintWeight in TimetableConstraintConfiguration).
 */
