...
```
Task(
  prompt="Read /Users/vid/Documents/GitHub/agentic-research/openaustria-school-flow/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/vid/Documents/GitHub/agentic-research/openaustria-school-flow/.claude/get-shit-done/templates/SECURITY.md`
