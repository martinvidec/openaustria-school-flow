...
- **Global scope**: `/Users/vid/Documents/GitHub/agentic-research/openaustria-school-flow/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/vid/Documents/GitHub/agentic-research/openaustria-school-flow/.claude/notes/`)
...
2. Glob `/Users/vid/Documents/GitHub/agentic-research/openaustria-school-flow/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/vid/Documents/GitHub/agentic-research/openaustria-school-flow/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/vid/Documents/GitHub/agentic-research/openaustria-school-flow/.claude/notes/` — works in any directory
